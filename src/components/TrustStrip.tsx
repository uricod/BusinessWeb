...
export default function TrustStrip({ active = true }: TrustStripProps) {
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl border border-slate-200/70 bg-navy shadow-[0_26px_70px_-35px_rgba(15,23,42,0.85)]">
        ...
        <div className="relative px-5 py-3.5 sm:px-6 sm:py-4">
          ...
          <div className="grid grid-cols-1 gap-2 text-center sm:grid-cols-3 sm:gap-4">
            {trustPoints.map((point, i) => (
              ...
              >
                <span className="bg-gradient-to-r from-yellow-200 via-yellow-300 to-yellow-500 bg-clip-text text-3xl font-bold tracking-tight text-transparent sm:text-[2.15rem]">
                  {point.metric}
                </span>
